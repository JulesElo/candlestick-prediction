...
def calculate_normalization_params(data_dir):
    """
    ...
    print("Lendo imagens e calculando média e desvio padrão. Aguarde...")
...
if __name__ == "__main__":
    # Aponta para a pasta raiz das suas imagens
    data_directory = os.path.join("..", "images")
    
    try:
        mean, std = calculate_normalization_params(data_directory)
